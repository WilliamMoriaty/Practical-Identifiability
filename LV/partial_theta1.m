...
%     dydt(2) = delta * x * y - gamma * y; % Predator equation
    ...
    dxdthe1(1) = x(3) + J(1,1)*x(1) + J(1,2)*x(2);
    dxdthe1(2) = J(2,1)*x(1) + J(2,2)*x(2);
    dxdthe1(3) = alpha * x(3) - beta * x(3) * x(4);  % Prey equation
    dxdthe1(4) = delta * x(3) * x(4) - gamma * x(4); % Predator equation
end