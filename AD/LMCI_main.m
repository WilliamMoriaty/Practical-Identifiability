...
para(3) = 6.90*10^(-3);%lambda_Ntaup = para(3);
para(4) = 1.67e-1;%lambda_CN = para(4);
para(5) = 0.83e-3;%lambda_Ctau = para(5);
para(6) = 259.44;% K_Ab = para(6);
...
y10 = 36.03;  % Initial Ab
y20 = 12.38;  % Initial tau_p
y30 = 0.22;  % Initial N
y40 = 1.68; % Initial C
...
load('LMCI_data/LMCI_112_13.mat')
load('LMCI_data/LMCI_112_45.mat')
[NAge, idx] = sort(NAge);
 N_PID = N_PID(idx);
 C_PID = C_PID(idx);
